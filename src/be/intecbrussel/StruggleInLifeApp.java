...
public class StruggleInLifeApp {
    ...
    public static void doDailyRoutine(String day, String userName, String replaceMom,
                                       String startPos, String endPos, int startHour,
                                       int endHour, String food, boolean timeForRelaxing,
                                       boolean willSleep) {

        printThemLines(50,day);
        morningRoutine(userName,replaceMom);
        transport(startPos,endPos);
        workRoutine(startHour,endHour);
        transport(endPos,startPos);
        eveningRoutine(food,timeForRelaxing,willSleep);

    }


    private static void morningRoutine(String userName,
                                       String replaceMom) {
        ...
        System.out.println("Brush your teeth, nobody want to smell!");
    }
    ...
    private static void eveningRoutine(String food, boolean timeForRelaxing,
                                       boolean willSleep) {

        printThemLines(50, "evening routine");
        System.out.println("Today we eat: " + food);
        String eveningActivity = (timeForRelaxing) ? "Time to relax now" :
                "Work is fun, now work more...";
        System.out.println(eveningActivity);
        String sleepTonight = willSleep ? "Ok, you earned it.\nYou can go to sleep" :
                "Who needs sleep if you can work";
    ...
    private static void transport(String startPoint, String endPoint) {
        ...
        System.out.println("Sorry but you will be " + (rand.nextInt(30) + 1)
                + " minutes late.");
